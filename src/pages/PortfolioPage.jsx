...
function PortfolioPage({ isDark, setIsDark }) {
  ...
  const toolCategories = [
    { name: 'CRM & Support', tools: [
      { name: 'Intercom', icon: 'https://img.icons8.com/color/48/intercom.png' },
    ...
    { name: 'Communication', tools: [
      ...
      { name: 'Google Meet', icon: 'https://img.icons8.com/color/48/google-meet.png' },
      { name: 'Skype', icon: 'https://img.icons8.com/color/48/skype.png' },
    ]},
    { name: 'Project Management', tools: [
      { name: 'Trello', icon: 'https://img.icons8.com/color/48/trello.png' },
      { name: 'ClickUp', icon: 'https://img.icons8.com/color/48/clickup.png' },
      { name: 'Notion', icon: 'https://img.icons8.com/color/48/notion.png' },
      { name: 'Asana', icon: 'https://cdn.worldvectorlogo.com/logos/asana-logo.svg' },
    ]},
    { name: 'eCommerce', tools: [
      { name: 'Shopify', icon: 'https://img.icons8.com/color/48/shopify.png' },
      { name: 'WooCommerce', icon: 'https://img.icons8.com/color/48/woocommerce.png' },
      { name: 'Lightspeed', icon: 'https://img.icons8.com/fluency/48/pos-terminal.png' },
    ]},
    ...
    { name: 'Productivity', tools: [
      ...
      { name: 'Microsoft 365', icon: 'https://img.icons8.com/color/48/microsoft.png' },
      { name: 'ChatGPT', icon: 'https://img.icons8.com/color/48/chatgpt.png' },
      { name: 'Claude', icon: 'https://img.icons8.com/ios-filled/50/228BE6/bot.png' },
    ]},
  ];
