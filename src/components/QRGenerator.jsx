      ...
      <div className="mb-6 flex items-center gap-3">
        ...
        <div className="flex-1 min-w-0">
          <h1 className="text-xl md:text-3xl font-bold mb-1 flex items-center gap-2" style={{ color: theme.text, fontFamily: FONTS.heading }}>
            <QrCode className="size-5 md:size-8 shrink-0" style={{ color: BRAND.blue }} />
            <span className="truncate">QR Code Generator</span>
          </h1>
          <p className="text-xs md:text-sm text-muted-foreground hidden sm:block">Create QR codes for URLs, text, WiFi credentials, and more</p>
        </div>
      </div>
