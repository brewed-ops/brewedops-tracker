...
const INTERACTIVE_SELECTORS = 'a, button, [role="button"], input, textarea, select, [onclick], label[for]';

const CursorSVG = ({ isHovering }) => {
  return (
    <svg
      ...
      viewBox="0 0 50 54"
      fill="none"
      style={{ scale: 0.5, transition: 'filter 0.2s ease' }}>
      <g filter="url(#filter0_d_91_7928)">
        <path
          d="M42.6817 41.1495L27.5103 6.79925C26.7269 5.02557 24.2082 5.02558 23.3927 6.79925L7.59814 41.1495C6.75833 42.9759 8.52712 44.8902 10.4125 44.1954L24.3757 39.0496C24.8829 38.8627 25.4385 38.8627 25.9422 39.0496L39.8121 44.1954C41.6849 44.8902 43.4884 42.9759 42.6817 41.1495Z"
          fill={isHovering ? "#004AAC" : "black"}
...
export function SmoothCursor({
  ...
  // Inject global cursor:none style so no element can show the default cursor
  useEffect(() => {
  ...
  useEffect(() => {
    ...
    const smoothMouseMove = (e) => {
      ...
      const interactive = target && (target.closest(INTERACTIVE_SELECTORS))
  ...
  return (
    <motion.div
      ...
      <CursorSVG isHovering={isHovering} />
    </motion.div>
  );
}
