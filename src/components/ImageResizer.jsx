...
import { 
  ...
  ArrowRight, Instagram, Facebook, Twitter, Linkedin, Youtube, Monitor, PanelLeft
} from 'lucide-react';
      ...
      <div className="mb-6 flex items-center gap-3">
        ...
        <div className="flex-1 min-w-0">
          <h1 className="text-xl md:text-3xl font-bold mb-1 flex items-center gap-2" style={{ color: theme.text, fontFamily: FONTS.heading }}>
            ...
            <span className="truncate">Image Resizer</span>
          </h1>
          <p className="text-xs md:text-sm text-muted-foreground hidden sm:block">Resize images to exact dimensions or social media presets</p>
        </div>
      </div>
