...
import { X, CaretDown, Lock, Lightning, FileMagnifyingGlass, Image, Scissors, ArrowsOut, ArrowsIn, ArrowsClockwise, Palette, FileImage, FilmStrip, NotePencil, GitMerge, FileDashed, BookOpen, QrCode, MagnifyingGlass, TextT, Hash, GitBranch, BracketsCurly, Clock, Globe, Timer, PenNib, ChatCircle, TextAa, FileText, ClipboardText, CalendarDots } from '@phosphor-icons/react';
...
const AI_TOOLS = [
  ...
  { icon: TextAa, title: 'AI Grammar Polisher', path: '/grammar-polisher' },
  { icon: PenNib, title: 'AI Proposal Writer', path: '/proposal-writer' },
  { icon: FileText, title: 'AI SOW Generator', path: '/sow-generator' },
  { icon: ClipboardText, title: 'AI Onboarding Checklist', path: '/onboarding-checklist' },
  { icon: CalendarDots, title: 'AI Content Calendar', path: '/content-calendar' },
