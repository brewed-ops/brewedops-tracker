...
import {
  ...
  Lock, CurrencyDollar, Note, CheckSquare, FileMagnifyingGlass, PenNib, ChatCircle, Headphones, TextAa,
  FileText, ClipboardText, CalendarDots
...
const getTheme = (isDark) => ({
  ...
  textFaint: isDark ? '#9a8d80' : '#6b5f52',
});
    ...
    <div style={{ minHeight: '100vh', backgroundColor: isDark ? '#0a0a0b' : '#ffffff', fontFamily: FONTS.body }}>
      ...
      <footer style={{
        ...
        <div style={{ 
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            <img src="/BrewedOpsLogo-64.png" alt="BrewedOps Logo" width={28} height={28} style={{ width: '28px', height: '28px', borderRadius: '6px' }} />
